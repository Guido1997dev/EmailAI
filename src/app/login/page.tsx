  ...
  return (
    <main className="mx-auto max-w-md px-6 py-12 grid gap-6">
      ...
      <form onSubmit={loginWithPassword} className="grid gap-3">
        ...
        <button disabled={loading} className="rounded-md px-4 py-2 bg-black text-white dark:bg-white dark:text-black border border-black/10 dark:border-white/20" type="submit">Login</button>
      </form>
